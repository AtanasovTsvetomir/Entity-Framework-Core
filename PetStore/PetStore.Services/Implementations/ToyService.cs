namespace PetStore.Services.Implementations
{
    ...
    public class ToyService : IToyService
    {
        ...
        public void BuyFromDistributor(string name, string desciption,
            decimal distributorPrice, double profit, int brandId, int categoryId)
        {
        ...
        public void BuyFromDistributor(AddinToyServiceModel model)
        {
        ...
        public void SellToyToUser(int toyId, int userId)
        {
            ...
            {
                throw new ArgumentException("There is no such user with the give id in the database.");
            }
